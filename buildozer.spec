...
#source.include_exts = py,png,jpg,kv,atlas,ttf,db,wav,mp4

# (list) List of inclusions using pattern matching
#source.include_patterns = frm/*.png
#source.include_patterns = resources/images/*.png, resources/services/*.py, resources/databases/*.db, resources/fonts/*.ttf, resources/sound/*.wav, supperwidget/*.py, supperwidget/*.kv
...
icon.adaptive_foreground.filename = small_icon.png
...
#android.sdk = 33
#was commented the sdk line this me 
